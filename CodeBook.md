...
To put the summary data set within its broader context, here is a copy of the description of the original data set.
###Experiment
...
* **Meaning**: The frequency dependent body acceleration Jerk signal magnitude mean value, as deduced from the accelerometer measurements.
* **Value type**: double

###FrequencyBodyAccelerationJerkMagnitudeStandardDeviation
* **Original name**: *fBodyBodyAccJerkMag-std()*
* **Meaning**: The frequency dependent body acceleration Jerk signal magnitude standard deviation, as deduced from the accelerometer measurements.
* **Value type**: double

###FrequencyBodyGyroscopeMagnitudeMeanValue
* **Original name**: *fBodyBodyGyroMag-mean()*
* **Meaning**: The frequency dependent body angular velocity magnitude mean value, as deduced from the gyroscope measurements.
* **Value type**: double

###FrequencyBodyGyroscopeMagnitudeStandardDeviation
* **Original name**: *fBodyBodyGyroMag-std()*
* **Meaning**: The frequency dependent body angular velocity magnitude standard deviation, as deduced from the gyroscope measurements.
* **Value type**: double

###FrequencyBodyGyroscopeJerkMagnitudeMeanValue
* **Original name**: *fBodyBodyGyroJerkMag-mean()*
* **Meaning**: The frequency dependent body angular velocity Jerk signal magnitude mean value, as deduced from the gyroscope measurements.
* **Value type**: double

###FrequencyBodyGyroscopeJerkMagnitudeStandardDeviation
* **Original name**: *fBodyBodyGyroJerkMag-std()*
* **Meaning**: The frequency dependent body angular velocity Jerk signal magnitude standard deviation, as deduced from the gyroscope measurements.
* **Value type**: double
